  ...
  private readonly allProjects: Project[] = [
    {
      ...
      image: 'images/projects/dzeus.png',
      url: 'https://dzeus.com',
    },
    {
      id: 'dinofeedback',
      ...
      accentColor: '#f5c400',
      icon: 'reviews',
      image: 'images/projects/dinofeedback.png',
    ...
    {
      id: 'placeholder1',
      title: 'projects.items.placeholder1.title',
      description: 'projects.items.placeholder1.description',
      tags: ['TBD'],
      category: 'fullstack',
      accentColor: '#f5c400',
      icon: 'hourglass_top',
    ...
    {
      id: 'placeholder2',
      title: 'projects.items.placeholder2.title',
      description: 'projects.items.placeholder2.description',
      tags: ['TBD'],
      category: 'devsecops',
      accentColor: '#1a1a1a',
      icon: 'hourglass_top',
